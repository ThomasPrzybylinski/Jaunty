...
//e.g. with watched literals


@Deprecated
public class LocalCNFClauses {
	...
	public LocalCNFClauses(CNF list) {
		this(list,false);
	}

	public LocalCNFClauses(CNF list, boolean copy) {
	...
	public CNF getCurList(int[] canonical) {
