...
public class AllRectanglesOnSphere implements ModelGiver, ConsoleDecodeable, FileDecodable {
	private int size;

	public AllRectanglesOnSphere(int size) {
		this.size = size;
	}
	...
	public String toString() {
		return "AllRectangesOnSphere="+size;
	}
