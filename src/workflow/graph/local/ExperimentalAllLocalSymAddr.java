...
public class ExperimentalAllLocalSymAddr extends AbstractExperimentalAllLocalSym {
	...
	public ExperimentalAllLocalSymAddr(boolean checkFirstInLocalOrbit, boolean checkLitGraph,
...
//		lp.children = null;
	...
	protected void computeCurModels(LatticePart lp, PossiblyDenseGraph<int[]> g) {
