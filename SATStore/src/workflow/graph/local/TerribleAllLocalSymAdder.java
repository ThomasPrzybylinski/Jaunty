...
public class TerribleAllLocalSymAdder extends ReportableEdgeAddr {
	private int iters;
	...
	private final boolean globPrune = false;

	private SmallerIsomorphFinder iso = new SmallerIsomorphFinder();

	public TerribleAllLocalSymAdder() {}
	...
	private void generateNext(PossiblyDenseGraph<int[]> g, LocalSymClauses clauses, DirectedLitGraph litGraph,
		...
		for(int next : validLits) {
			...
			int[] nextCanon = nextFilter;//clauses.getCanonicalInter(nextFilter);
