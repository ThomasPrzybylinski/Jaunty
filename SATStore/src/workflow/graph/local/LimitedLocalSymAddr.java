...
public class LimitedLocalSymAddr extends AbstractLimitedLocalSym {
	public LimitedLocalSymAddr() {
		super();
		init();
	}

	public LimitedLocalSymAddr(boolean checkFirstInLocalOrbit, boolean checkLitGraph,
