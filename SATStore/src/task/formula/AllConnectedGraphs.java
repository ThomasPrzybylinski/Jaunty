...
public class AllConnectedGraphs implements ModelGiver, ConsoleDecodeable,FileDecodable {
	private int numNodes;
	private ClauseList debug;
	VariableContext theContext;
	public AllConnectedGraphs(int numNodes) {
