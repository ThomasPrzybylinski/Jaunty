...
public class SparseOnlineCNFDiversity {
	...
	public SparseOnlineCNFDiversity(CNFCreator creat) {
		this.creator = creat;
	}

	public SparseOnlineCNFDiversity(CNFCreator creat, int[] initial) {
		this.creator = creat;
	...
	public List<int[]> getDivSetFromCNF(FormulaCreatorRandomizer randomizer,
		...
		form = new FormulaForAgreement(origCNF);
		...
		if(useGlobalSymBreak) {
			...
			finder = new SparseSymFinder(origCNF);
