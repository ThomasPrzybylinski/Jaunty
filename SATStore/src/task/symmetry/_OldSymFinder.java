...
import util.lit.MultilevelLitSet;
...
public class _OldSymFinder {
	...
	public _OldSymFinder(CNF cnf) {
		...
		checkClauses = new LitsSet(cnf.getContext().size()); //new HashSet<int[]>();
	...
	public List<int[]> getSyms() {
		...
		MultilevelLitSet exploredPairs = new MultilevelLitSet(cnf.getContext().size());
