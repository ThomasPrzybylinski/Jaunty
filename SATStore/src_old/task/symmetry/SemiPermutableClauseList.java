...
public class SemiPermutableClauseList extends ClauseList {
	...
	private void setupDataStructures() {
		clauseChecker = new LitsMap<Integer>(getContext().getNumVarsMade());
		clausesWithVar = new ClausePos[getContext().getNumVarsMade()+1][];
		permutedLevel = new int[getContext().getNumVarsMade()+1];
		...
		for(int k = 0; k < getContext().getNumVarsMade();k++) {
			temp.add(new ArrayList<ClausePos>());
		}
